...
try:
    ...
    try:
        ...
        from cuda import cuda as cuda          # legacy
...
try:
    ...
    try:
        ...
        from cuda import cudart as cudart        # legacy

cudaMallocManaged = cudart.cudaMallocManaged
cudaHostAlloc = cudart.cudaHostAlloc
cudaHostAllocMapped = cudart.cudaHostAllocMapped
cudaHostGetDevicePointer = cudart.cudaHostGetDevicePointer
cudaMemAttachGlobal = cudart.cudaMemAttachGlobal
cudaGetLastError = cudart.cudaGetLastError
cudaGetErrorString = cudart.cudaGetErrorString
cudaError_t = cudart.cudaError_t
